...
async function getStaticPaths() {
  ...
  try {
    const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://matetami:Tamiwarrior0913@cluster0.ythrc.mongodb.net/meetups?retryWrites=true&w=majority");
    const db = client.db();
